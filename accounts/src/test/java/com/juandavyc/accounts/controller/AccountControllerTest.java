...
//
//    @Test
//    void shouldReturnValidationErrorWhenGiveWrongDataWhileUpdateAccount() {
//        long id = 1L;
//        AccountUpdateDto requestDto = new AccountUpdateDto(
//                "",
//                "test.com"
...
//                .isNotNull();
//
//        assertThat(updateAccountResponse.getBody().getErrors())
//                .containsKeys("username", "email");
//
//    }
//
...
//        long id = 1L;
//
//        ResponseEntity<ResponseDto<String>> deleteAccountResponse =
//                testRestTemplate.exchange(
//                        API_ACCOUNTS_PATH + "/" + id,
//                        HttpMethod.DELETE,
//                        HttpEntity.EMPTY,
...
//                );
//
//        assertThat(deleteAccountResponse.getStatusCode())
//                .isEqualTo(HttpStatus.OK);
//        assertThat(deleteAccountResponse.getBody())
//                .isNotNull();
//
//        assertThat(deleteAccountResponse.getBody().getMessage())
//                .isEqualToIgnoringCase("Request processed successfully");
//
//
//        ResponseEntity<ErrorResponseDto> fetchAccountResponse =
//                testRestTemplate.exchange(
//                        API_ACCOUNTS_PATH + "/" + id,
//                        HttpMethod.GET,
//                        HttpEntity.EMPTY,
...
//
//
//        assertThat(fetchAccountResponse.getStatusCode())
//                .isEqualTo(HttpStatus.NOT_FOUND);
//
//    }
//
//    @Test
//    void shouldReturnNotFoundWhenGiveInvalidIDWhileDeleteAccount() {
//        long id = 9999L;
//        ResponseEntity<ErrorResponseDto> deleteAccountResponse =
//                testRestTemplate.exchange(
//                        API_ACCOUNTS_PATH + "/" + id,
//                        HttpMethod.DELETE,
//                        HttpEntity.EMPTY,
